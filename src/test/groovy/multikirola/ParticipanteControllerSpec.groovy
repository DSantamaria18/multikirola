...
class ParticipanteControllerSpec extends Specification implements ControllerUnitTest<ParticipanteController>, DomainUnitTest<Participante> {
    ...
    void "Test the save action with an invalid instance"() {
        ...
        controller.participanteService = Mock(ParticipanteService) {
            1 * save(_ as Participante) >> { Participante participante ->
                throw new ValidationException("Invalid instance", participante.errors)
            }
        }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Participante())
